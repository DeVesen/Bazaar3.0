...
namespace BAR.Modules.Anmeldung.Domain.Articles;
...
public sealed class Article
{
    ...
    /// <summary>Angestossen vom BrandRenamed-Event aus Stammdaten - siehe Application/EventHandlers.</summary>
    public void RenameBrand(string newName) => Brand = newName;

    /// <summary>Angestossen vom CategoryRenamed-Event aus Stammdaten.</summary>
