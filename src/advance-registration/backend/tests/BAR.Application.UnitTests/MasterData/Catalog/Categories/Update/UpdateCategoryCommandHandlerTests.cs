...
namespace BAR.Application.UnitTests.MasterData.MasterData.Categories.Update;
...
public class UpdateCategoryCommandHandlerTests
{
    ...
    public async Task HandleAsync_RenamesCategory()
    {
        ...
        // The cascading rename in Registration now runs via the CategoryRenamed
        // event, no longer via a renameArticlesFrom parameter here.
