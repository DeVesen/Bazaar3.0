...
namespace BAR.Application.UnitTests.SellerManagement.Auth.Refresh;
...
public class RefreshCommandHandlerTests
{
    ...
    {
        // Runs the delegate directly - the transaction wrapper itself is
        // infrastructure and isn't reproduced here.
        _unitOfWork
    ...
    public async Task HandleAsync_ValidToken_RotatesAndReturnsNewPair()
    {
        ...
        // Delete and create must not run as two independent commits.
