...
namespace BAR.Application.UnitTests.SellerManagement.Auth.Login;
...
public class LoginCommandHandlerTests
{
    ...
    {
        var seller = SetUpValidLogin();
        // Exactly the boundary from below: with 4 active sessions none may
        // be deleted yet, otherwise the cap would be ">" instead of ">=" 5.
    ...
    public async Task HandleAsync_UnknownEmail_ThrowsUnauthorized()
    {
        ...
        // Even without a match, a verify runs against the dummy hash so the
