...
namespace BAR.Application.UnitTests.Registration.Articles.GetById;
...
public class GetArticleByIdQueryHandlerTests
{
    ...
    private GetArticleByIdQueryHandler CreateHandler() => new(_articles.Object, _blocks.Object, _sellerManagement.Object);
    ...
    public async Task HandleAsync_KnownId_ReturnsArticleWithSeller()
    {
        ...
        _sellerManagement.Setup(v => v.GetSellerNamesAsync(It.Is<IReadOnlyCollection<string>>(ids => ids.Contains(sellerId)), It.IsAny<CancellationToken>()))
