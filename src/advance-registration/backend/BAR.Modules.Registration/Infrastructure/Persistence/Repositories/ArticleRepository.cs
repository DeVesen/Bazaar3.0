...
public sealed class ArticleRepository(RegistrationDbContext dbContext) : IArticleRepository
{
    ...
    // ChangeTracker - already-tracked Article instances would otherwise
    // still hold the old name in memory.
