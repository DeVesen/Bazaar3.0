...
import { SellerTypeOptionsApiService } from '@features/operations/seller-type-options-api.service';
...
function create(initial: SettingsDto = EMPTY_SETTINGS, locale: 'de' | 'en' = 'de') {
  ...
  vi.spyOn(sellerTypeApi, 'getAll').mockReturnValue(of([{ id: 't1', name: 'Standard', commissionRate: 15, itemFee: 0.5 }]));
