...
describe('RegisterPage', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      // Stub route for /home: a successful registration really navigates
      // there (vi.spyOn also calls the original). Without the route the
      // navigation gets rejected after teardown and Vitest reports an
      // Unhandled Rejection.
      providers: [
        provideHttpClient(),
  ...
  it('on 500 shows a generic error without touching the two specific 409 signals', () => {
    ...
    expect(fixture.componentInstance.registrationNotEnabled()).toBe(false);
    // The form stays as is, the message is actually visible.
    expect(fixture.nativeElement.querySelector('app-registration-form')).not.toBeNull();
  ...
  it('on 409 registration.not_enabled shows the alternate message instead of the form', () => {
    ...
    expect(fixture.nativeElement.querySelector('app-registration-form')).toBeNull();
