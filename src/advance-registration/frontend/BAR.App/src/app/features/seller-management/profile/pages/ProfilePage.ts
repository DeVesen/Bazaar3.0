...
export class ProfilePage {
  ...
  // Strength is computed directly from the password instead of via an output
  // event from the child component (app-password-strength-meter), which only
  // updates through change detection: canChangePassword() must also evaluate
  // correctly immediately after a signal.set() (without an intermediate render).
