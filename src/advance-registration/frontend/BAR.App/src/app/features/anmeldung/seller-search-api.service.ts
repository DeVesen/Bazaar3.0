 ...
 * Artikel-Filter (Anmeldung). Ruft dieselbe Admin-Verkaeuferliste auf wie die
 * Verkaeuferverwaltung selbst - keine eigene Fachlogik, nur ein duenner Client
 * fuer diese eine Abfrage (angular-modulith-bridge: kein Cross-Feature-Import
 * von Verkaeuferverwaltungs SellersApiService).
 */
