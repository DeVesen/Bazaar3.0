...
import { MasterDataApiService, MasterDataItem } from '@features/anmeldung/master-data-api.service';
import { SellerSearchApiService } from '@features/anmeldung/seller-search-api.service';
...
@Component({
  ...
  imports: [FilterPanel, AppTable, ArtikelReadonlyModal, TranslatePipe],
  template: `
