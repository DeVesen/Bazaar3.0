...
/**
 * Duennes Read+Create-Gegenstueck zu Stammdaten/MasterDataApiService, fuer
 * das Autocomplete-Popup bei der Artikelerfassung (Anmeldung). Eigene Kopie
 * statt geteiltem Service ueber die Abteilungsgrenze hinweg - Anmeldung
 * importiert nie aus features/stammdaten (Cross-Feature-Import-Verbot gilt
