...
**Leerzustand:** „Noch keine Kategorien. Beim Import aus der Voranmelde-App werden sie mit übernommen." — überschreibt den generischen Text der [`table`](../../../../components/table/component.md) über `emptyText`.
...
9. **AC-9** — WHILE keine Kategorie vorhanden ist und kein Filter aktiv ist, SHALL die Tabelle „Noch keine Kategorien. Beim Import aus der Voranmelde-App werden sie mit übernommen." anzeigen.
