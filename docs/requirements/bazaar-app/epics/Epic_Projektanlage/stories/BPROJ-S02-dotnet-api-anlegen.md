...
Ein Entwickler legt das .NET 9 Minimal API Backend der Haupt-App als hexagonale Projektstruktur (vier csproj) an und konfiguriert die Grundlage für JWT-Authentifizierung, zentrale Fehlerabbildung, Validierung sowie einen Health-Check-Endpoint.
