...
Der Artikel referenziert die Marke **über den Namen**, nicht über `id` — siehe
[artikel.md](artikel.md). Ein Umbenennen zieht den neuen Namen in alle betroffenen
Artikel nach.

## Verwendung

- [Epic_Marken](../epics/Epic_Marken/epic.md) — Verwaltung
...
**Tags:** #entity #marke #datenmodell #original-flag
