...
Setzt `Epic_Projektanlage` (VPROJ) voraus — das Angular-Projekt muss existieren.

`Epic_Login` (Seite) hängt von dieser Shell ab — die Guards und der AuthService müssen zuerst existieren.
