...
**Out of Scope:** Mobile-Burger-Menü (folgt in VSHELL-S02), Auth-Service (folgt in VSHELL-S04), tatsächliche Artikel-Zahl-API-Anbindung (folgt in Feature_Meine_Artikel).
...
**Sidebar-Footer-Maße (aus requirements.md §13.7):**
