...
# Feature: Projektanlage — Voranmelde-App
...
Dieses Feature ist ein **technisches Setup-Feature** — kein fachlicher Durchstich. Es ist Voraussetzung für alle nachfolgenden Features. Siehe Entwicklungsrichtlinie in `CLAUDE.md`.
