...
Sitzt im `p-sidebar-header`-Slot des Sidebar-Compounds (siehe `components/sidebar.md`). Kein Collapse-Toggle daneben — der lebt separat im Content-Header (VSHELL-S02).
