...
| Fall | Komponente |
|---|---|
| Kurze CRUD-Bestätigung („✓ … gespeichert") | [Toast](toast.md) — Auto-Dismiss |
...
[Confirmdialog](confirmdialog.md); der API-Call erfolgt erst nach Bestätigung. Der
...
[input.md](input.md) Modifier Readonly, [select.md](select.md) `[disabled]="true"`.
...
([input.md](input.md) Modifier Autofokus). Bei readonly-Dialogen kein Autofokus.
