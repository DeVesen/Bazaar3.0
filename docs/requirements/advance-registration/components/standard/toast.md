...
|---|---|---|
| [verkaeufer-dialog.md](../forms/verkaeufer-dialog.md) | Einladungs-Link kopieren | „✓ Einladungs-Link kopiert!" |
| [verkaeufer-dialog.md](../forms/verkaeufer-dialog.md) | Speichern (Erfolg/Fehler) | „✓ Verkäufer gespeichert" / Fehler-InfoArea |
| [stammdaten-popup.md](../forms/stammdaten-popup.md) | Speichern | „✓ Marke gespeichert" / „✓ Kategorie gespeichert" |
| [typ-popup.md](../forms/typ-popup.md) | Speichern | „✓ Verkäufer-Typ gespeichert" |
| [einstellungen-form.md](../forms/einstellungen-form.md) | Speichern | „✓ Einstellungen gespeichert" |
