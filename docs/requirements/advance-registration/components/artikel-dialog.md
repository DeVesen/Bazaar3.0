...
| Feld                | PrimeNG                                                                                                                                                                                                                                                                                |
| ------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Artikelnummer       | [Input](input.md) readonly                                                                                                                                                                                                                                                             |
| Bezeichnung         | [Input](input.md)                                                                                                                                                                                                                                                                      |
...
| Größe               | [Input](input.md)                                                                                                                                                                                                                                                                      |
| Farbe               | [Input](input.md)                                                                                                                                                                                                                                                                      |
| Preis               | Shared [`input-group`](../../../components/input-group/component.md) (`p-inputgroup`+[Number-Input](number-input.md)+`p-inputgroupaddon` „€" rechts) — bewusst **nicht** [Icon-Input](icon-input.md), Suffix-Betrag passt besser zum InputGroup-Addon-Muster als zu einem Icon-Overlay |
