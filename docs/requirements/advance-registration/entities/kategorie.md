...
- [Epic_Kategorien](../epics/Epic_Kategorien/epic.md) — Verwaltung durch Admin
- [Epic_Meine_Artikel](../epics/Epic_Meine_Artikel/epic.md) — AutoComplete-Create beim Artikel-Feld `kategorie`
- [Epic_Export](../epics/Epic_Export/epic.md) — optional exportierbar

## Tags & Piles

**Tags:** #entity #kategorie #datenmodell
