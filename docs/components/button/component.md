...
Praktisch jede Komponente mit Formular/Dialog/Aktion — siehe die jeweiligen `Aufbau`-Tabellen (login-form, registrierung-form, artikel-dialog, master-data-popup, typ-popup, filter-panel, sidebar-footer, export-panel, verkaeufer-dialog, profil-page).
