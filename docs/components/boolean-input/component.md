...
| [verkaeufer-dialog.md](../../requirements/advance-registration/components/verkaeufer-dialog.md) | Admin-Rechte | Switch |
| [master-data-popup.md](../master-data-popup/component.md) | `original`-Flag (Marke, Kategorie — nur Edit-Modus) | Switch |
